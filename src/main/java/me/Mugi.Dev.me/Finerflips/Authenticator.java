...
public class Authenticator {
    private static final String BASE_URL = "https://FF.robothanzo.dev/auth";
    ...
    public static JsonElement getAuthenticatedJson(String jsonUrl) throws IOException {
        ...
        connection.setRequestProperty("User-Agent", "Finerflips/2.1.0");
    ...
    private String verifyAuth(String tempToken) throws IOException {
        ...
        urlConnection.setRequestProperty("User-Agent", "FinerFlips Authentication Service/1.0");
